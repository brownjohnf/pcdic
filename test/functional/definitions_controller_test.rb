...
class DefinitionsControllerTest < ActionController::TestCase
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post :create, definition: { content: @definition.content, priority: @definition.priority, word_id: @definition.word_id }
    end
  ...
  test "should update definition" do
    put :update, id: @definition, definition: { content: @definition.content, priority: @definition.priority, word_id: @definition.word_id }
    assert_redirected_to definition_path(assigns(:definition))
  end
