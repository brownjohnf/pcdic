...
class UsagesControllerTest < ActionController::TestCase
  ...
  test "should create usage" do
    assert_difference('Usage.count') do
      post :create, usage: { example: @usage.example, priority: @usage.priority, word_id: @usage.word_id }
    end
  ...
  test "should update usage" do
    put :update, id: @usage, usage: { example: @usage.example, priority: @usage.priority, word_id: @usage.word_id }
    assert_redirected_to usage_path(assigns(:usage))
  end
